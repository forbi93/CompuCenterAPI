...
namespace CompuCenterAPI.Migrations
{
    ...
    [Migration("20231119215804_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClienteVenta", b =>
                {
                    b.Property<Guid>("ClientesIdCliente")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("VentasIdVenta")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ClientesIdCliente", "VentasIdVenta");

                    b.HasIndex("VentasIdVenta");

                    b.ToTable("ClienteVenta");
                });
            ...
            modelBuilder.Entity("ClienteVenta", b =>
                {
                    b.HasOne("CompuCenterAPI.Models.Domain.Cliente", null)
                        .WithMany()
